            ...
            {selectedEventModal.pricing === 'pago' ? (
              ...
              <div className="p-3.5 rounded-2xl bg-gradient-to-r from-[#D4AF37]/15 via-[#F5D77F]/10 to-[#D4AF37]/15 border border-[#D4AF37]/40 flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[11px] text-slate-300">
                    Evento fechado e restrito aos membros associados. Não há inscrições abertas para
                    o público externo.
                  </p>
                </div>
              </div>
            ...
            <DialogFooter className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-slate-800">
              ...
              <div className="flex items-center gap-3">
                {selectedEventModal.pricing === 'pago' ? (
                  user ? (
                    <Link
                      to={`/encontros?id=${selectedEventModal.id}`}
                      className="text-xs text-[#F5D77F] hover:text-[#FFF0B8] hover:underline flex items-center gap-1 font-medium"
                    >
                    ...
                    >
                      ...
                      <span>Área de Membros VIP (Login)</span>
                    </Link>
                  )
                ) : user ? (
